...
for theta in thetas:
    for ind, t in enumerate(ts):
        for hh in range(0, 10):
            ...
            testset = pd.read_excel('...\\path_to_file\\APTWN_testset.xlsx')
            ...
            asserts, probs = GetFailAndPassAssertions(failassertions[ind*30 + 450:ind*30 + 29 + 450].reset_index(),passassertions[ind*30 + 450:ind*30 + 29 + 450].reset_index(), theta)
            ...
            file_exists = os.path.isfile('GP-'+t+'-coveredpoints-ultra-theta'+str(theta)+'-testset.xlsx')
