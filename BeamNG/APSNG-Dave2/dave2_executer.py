...
class Dave2Executor(AbstractTestExecutor):
    ...
    def _execute(self, the_test, weather):
        ...
        return test_outcome, description, execution_data, minimumoob_distance
    ...
    def _run_simulation(self, the_test, weather) -> SimulationData:
        ...
        try:
            ...
            self.sim_data_collector.save()
            if oobbb == True:
                self.sim_data_collector.get_simulation_data().end(success=False)
            try:
        ...
        return self.sim_data_collector.simulation_data, minimumoob_distance
    ...
    def _run_simulation(self, the_test, weather) -> SimulationData:
        ...
        try:
            ...
            while True:  #was time.time() - startt < 15
                ...
                last_state: SimulationDataRecord = self.sim_data_collector.states[-1]
                # Target point reached
                if points_distance(last_state.pos, waypoint_goal.position) < 8.0 or time.time() - startt > 15:
                    break
        ...
        return self.sim_data_collector.simulation_data, minimumoob_distance, alloob_distances
