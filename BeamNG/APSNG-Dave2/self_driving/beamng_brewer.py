#This code adds additional functionalities to the beamng_brewer code from https://github.com/sbft-cps-tool-competition/cps-tool-competition/tree/main
...
class BeamNGBrewer:
    ...
    def bring_up(self, weather):
        ...
        self.beamng.set_weather_preset(weathers[weather])
